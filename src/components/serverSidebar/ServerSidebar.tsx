...
export default function ServerSidebar({
  ...
  return (
    <div className="w-14 bg-gray-900 text-gray-600 h-full flex flex-col items-center py-3">
      {loading && <p className="text-gray-500 text-xs">読み込み中...</p>}
      {error && <p className="text-red-500 text-xs">{error}</p>}

      {/* スクロール可能なサーバーリスト */}
      <div className="flex flex-col items-center space-y-2 overflow-y-auto flex-1 w-full">
